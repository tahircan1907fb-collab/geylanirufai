               ...
               <div className="flex items-center justify-between mb-6">
                ...
                <section className="mt-6 bg-slate-900 border border-slate-700 rounded-xl p-5">
                     ...
                     <ul className="text-sm text-slate-300 space-y-1">
                          <li>Rozet: {form.heroBadge || '-'}</li>
                          <li>Başlık 1: {form.heroTitle1 || '-'}</li>
                          <li>Başlık 2: {form.heroTitle2 || '-'}</li>
                          <li>Buton 1: {form.heroButtonText1 || '-'}</li>
                          <li>Buton 2: {form.heroButtonText2 || '-'}</li>
                     </ul>
                </section>
           </form>
     );
