      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1 md:col-span-1">
                <h2 className="text-2xl font-heading font-bold text-gold-500 mb-4">GEYLANİ RUFAİ</h2>
                <p className="text-gray-400 text-sm leading-relaxed mb-6 font-serif">
                    İlim, irfan ve hizmet yolunda, gönülleri birleştirmek gayesiyle çıktığımız bu yolda, siz değerli gönül dostlarını da aramızda görmekten mutluluk duyarız.
                </p>
            </div>
