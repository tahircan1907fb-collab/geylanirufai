      ...
      <div className="container mx-auto px-4 relative z-10 text-center text-white">
        <div className="animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold mb-6 leading-tight">
            <span className="block text-gold-500">Geylani Rufai</span>
            <span className="block">İlim, İrfan ve Hizmet Yolu</span>
          </h1>
          
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-serif text-gray-200 mb-10 leading-relaxed">
            Tasavvuf geleneğini yaşatmak, gönülleri ilahi aşkla buluşturmak ve gelecek nesillere bu manevi mirası aktarmak amacıyla hizmet ediyoruz.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              Faaliyetlerimiz <ArrowRight size={20} />
            </a>
            <a 
              href="#contact"
